...
from agent import EmpatheticAgent
...
class Sim:
    def __init__(self, config: dict) -> None:
        ...
        LOGGER.info(f"Initializing simulation with T={self.T} timesteps and K={self.K} agents")

        # Initialize agents
        self.agents = []
        for k in range(self.K):
            self.agents.append(EmpatheticAgent(config=self.config, agent_num=k))
            LOGGER.info(f"  Agent {k} initialized")
